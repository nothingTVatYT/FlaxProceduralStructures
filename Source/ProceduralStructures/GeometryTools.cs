...
public static class GeometryTools
{
    ...
    public static bool RayHitTriangle(Vector3 origin, Vector3 direction, Vector3 v0, Vector3 v1, Vector3 v2,
        out Vector3 intersection, out float rayHitLength)
    {
        var edge1 = v1 - v0;
        var edge2 = v2 - v0;
    ...
    public static bool LineLineIntersect(Vector3 a, Vector3 b, Vector3 c, Vector3 d, out Vector3 intersection,
        out float m, out float n)
    {
        m = 0;
        n = 0;
        intersection = Vector3.Zero;
